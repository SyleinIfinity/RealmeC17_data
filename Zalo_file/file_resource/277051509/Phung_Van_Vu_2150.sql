...
INSERT INTO KhachHang (maKH, tenKH, SDT, Email, soDuTK,  soNhaTenDuong_KH ,PXNo)
VALUES
	('KH001', N'Nguyễn Văn A', '0123456789', 'A@gmail.com', 1000000, N'12 Nguyễn Nhàn','PX002'), 
	('KH002', N'Trần Thị B', '0123456780', 'B@gmail.com', 2000000, N'30 Trần Ngoc Sương','PX002'),
	('KH003', N'Phạm Văn C', '0123456781', 'C@gmail.com', 3000000, N'50 Cao Thắng','PX004'), 
	('KH004', N'Lê Thị D', '0123456782', 'D@gmail.com', 4000000, N'222 D.2 Tháng 9','PX003'),
	('KH005', N'Nguyễn Văn E',  '0123456783', 'E@gmail.com', 5000000, N'260 Xô Viết Nghệ Tĩnh','PX003'), 
	('KH006', N'Trần Thị F',  '0123456784', 'F@gmail.com', 6000000, N'37 An Dương Vương','PX008'), 
	('KH007', N'Đinh Văn G', '0123456785', 'G@gmail.com', 7000000, N'430 Điện Biên Phủ','PX009'), 
	('KH008', N'Lê Thị H',  '0123456786', 'H@gmail.com', 20000000, N'125 Mai Hắc Đế','PX005'),
	('KH009', N'Nguyễn Văn I',  '0123456787', 'I@gmail.com', 9000000, N'228 Nguyễn Hữu Thọ','PX003'),  
	('KH010', N'Trần Thị N',  '0123456788', 'J@gmail.com', 10000000, N'20 Nguyẽn Như Đỗ','PX001');
...
VALUES
	...
	('DH005', default, '0123456783', 'HD005', getdate()+4, getdate()+2, N'Đang giao', 'KH004', 'NV001', 'PX009', N'430 Ðiện Biên Phủ'),
...
INSERT INTO NhaCungCap (maNCC, tenNCC, soNhaTenDuong_NCC, SDT, nhanVienLienHe)   
VALUES
	('NCC001', N'Công ty J', N'357 Đường PQR, Quận LMN', '0951159753', N'Trần Thị J'),
	('NCC002', N'Công ty B', N'456 Đường PQR, Quận LMN', '0987654321', N'Trần Thị B'),
	('NCC003', N'Công ty C', N'789 Đường XYZ, Quận ABC', '0159753456', N'Phạm Văn C'),
	('NCC004', N'Công ty D', N'246 Đường LMN, Quận PQR', '0258951753', N'Lê Thị D'),
	('NCC005', N'Công ty G', N'258 Đường XYZ, Quận ABC', '0753159456', N'Phạm Văn G'),
	('NCC006', N'Công ty H', N'369 Đường LMN, Quận PQR', '0951753159', N'Lê Thị H'),
	('NCC007', N'Công ty E', N'369 Đường ABC, Quận XYZ', '0357951753', N'Nguyễn Văn E'),
	('NCC008', N'Công ty F', N'147 Đường PQR, Quận LMN', '0456753159', N'Trần Thị F'),
	('NCC009', N'Công ty I', N'159 Đường ABC, Quận XYZ', '0753951753', N'Nguyễn Văn I'),
	('NCC010', N'Công ty A', N'123 Đường ABC, Quận XYZ', '0123456789', N'Nguyễn Văn A');
...
*/ 
INSERT INTO ChiTietDonHang (SPNo, DHNo, soLuongDat, donGia) 
VALUES
	('SP004', 'DH005', 2, 100000),	
	('SP002', 'DH001', 3, 200000),
	('SP003', 'DH002', 1, 100000),
	('SP001', 'DH003', 5, 150000),
	('SP003', 'DH001', 2, 300000),
	('SP005', 'DH005', 1, 250000),
	('SP006', 'DH006', 4, 350000),
	('SP007', 'DH007', 1, 400000),
	('SP008', 'DH008', 2, 450000),
	('SP009', 'DH009', 1, 500000);

-- Thêm dữ liệu vào bảng ChiTietPhieuNhap
INSERT INTO ChiTietPhieuNhap (PNNo, SPNo, soLuongNhap, giaNhap)
VALUES
	('PN00001', 'SP001', 10, 90000),
	('PN00002', 'SP002', 15, 180000),
	('PN00003', 'SP003', 20, 140000),
...
/*
	Câu 4: 
		- Hãy hiển thị thông tin chi tiết của những sản phẩm đã từng được khách hàng mua, và có tổng số lượng sản phẩm được mua lớn hơn 10?
*/
select *
from SanPham
where maSP in (
	select maSP
	from chiTietDonHang
	where DHNo in (select maDH from DonDatHang_HoaDon where trangThaiDonHang = N'Đã giao thành công'
	group by maSP
