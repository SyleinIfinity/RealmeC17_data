...
GO
---------Câu d: Nguyễn Tuấn Anh
--Thêm tên công ty cho bảng KHACHHANG
UPDATE KHACHHANG
SET TENCONGTY = N'Công ty VINAMILK'
WHERE MAKHACHHANG IN('KH000001','KH000002','KH000003','KH000004');
...
UPDATE NHACUNGCAP
SET TENCONGTY = N'Công ty VINAMILK'
WHERE MACONGTY IN('CTY00001','CTY00002','CTY00003','CTY00004');
...
END
WHERE SOHOADON IN ('SHD00015', 'SHD00016', 'SHD00017', 'SHD00018', 'SHD00019', 'SHD00020');
