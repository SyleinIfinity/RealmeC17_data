-- Bước 1: Kiểm tra và xóa DB cũ nếu tồn tại để làm lại từ đầu
...
(1, N'Gà Hấp Hành', N'Con', 250000, 10, 'ga_hap_hanh.jpg', N'Gà ta hấp hành lá và gừng tươi, thịt mềm ngọt.', 1),
(2, N'Gà Quay', N'Con', 280000, 10, 'ga_quay.jpg', N'Gà quay da giòn rụm, tẩm ướp gia vị đậm đà.', 1),
(3, N'Gà Tiềm Thuốc Bắc', N'Thố', 150000, 15, 'ga_tiem.jpg', N'Gà ác tiềm thuốc bắc có công dụng bổ can thận, ích khí huyết, chữa các chứng bệnh hư nhược.', 1),
...
(6, N'Canh Chua Cá Lóc', N'Tô', 120000, 20, 'canh_chua.jpg', N'Canh chua cá lóc nấu với bạc hà, cà chua, giá đỗ theo phong vị miền Nam.', 5);
